...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Apartment Management System</a>
    ...
    <header class="masthead">
     ...
     <!-- Search -->
  <div style="color: black; font-size: 18px; background-color:silver; padding: 10px;">
  <section id="search">
      <div class="container">
        <div class="row">
